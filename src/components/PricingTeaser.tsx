...
export function PricingTeaser() {
  ...
  const plans = [
    { key: "one", icon: <LightningIcon />, name: "One-Time", note: "Perfect for trying the complete Brief experience.", value: pricing ? `From ${fmt(pricing.symbol, pricing.oneTime)}` : "Loading...", iconColor: "var(--accent2)", iconBg: "var(--tint)", cta: "View Pricing" },
    { key: "monthly", icon: <CalendarIcon />, name: "Monthly", note: "For publishers creating audio Briefs regularly.", value: pricing ? `From ${fmt(pricing.symbol, pricing.monthly)}/month` : "Loading...", iconColor: "var(--accent2)", iconBg: "var(--tint)", cta: "View Pricing" },
    { key: "annual", icon: <CrownIcon />, name: "Annual", note: "For regular publishing with the best value per Brief.", value: pricing ? `From ${fmt(pricing.symbol, pricing.annual)}/year` : "Loading...", cta: "View Pricing", badge: "Best Value", featured: true },
